...
{
    public class LeaveMasterViewModelWebAPI : ILeaveMasterViewModel
    {
        public LeaveMasterViewModelWebAPI()
        {
        ...
        public double BalanceLeave
        {
            get
            {
                return (LeaveMasterDTO != null && LeaveMasterDTO.BalanceLeave > 0) ? LeaveMasterDTO.BalanceLeave : new double();
            }
            set
            {
                LeaveMasterDTO.BalanceLeave = value;
            }
        }
        public int EmployeeID
        {
            get
            {
                return (LeaveMasterDTO != null && LeaveMasterDTO.EmployeeID > 0) ? LeaveMasterDTO.EmployeeID : new int();
            }
            set
            {
                LeaveMasterDTO.EmployeeID = value;
            }
        }
        ...
        public string XML
        {
            get
            {
                return (LeaveMasterDTO != null) ? LeaveMasterDTO.XML : string.Empty;
            }
            set
            {
                LeaveMasterDTO.XML = value;
            }
        }
        public string CentreCode
        {
            get
            {
                return (LeaveMasterDTO != null) ? LeaveMasterDTO.CentreCode : string.Empty;
            }
            set
            {
                LeaveMasterDTO.CentreCode = value;
            }
        }
        ...
        public TimeSpan CheckOutTime
        {
            get
            {
                return (LeaveMasterDTO != null) ? LeaveMasterDTO.CheckOutTime : TimeSpan.Zero;
            }
            set
            {
                LeaveMasterDTO.CheckOutTime = value;
            }
        }
        ...
        public TimeSpan CheckInTime
        {
            get
            {
                return (LeaveMasterDTO != null) ? LeaveMasterDTO.CheckInTime : TimeSpan.Zero;
            }
            set
            {
                LeaveMasterDTO.CheckInTime = value;
            }
        }
        ...
        public int LeaveSessionID
        {
            get
            {
                return (LeaveMasterDTO != null && LeaveMasterDTO.LeaveSessionID > 0) ? LeaveMasterDTO.LeaveSessionID : new int();
            }
            set
            {
                LeaveMasterDTO.LeaveSessionID = value;
            }
        }
