...
namespace AERP.Web.UI.Controllers
{
    ...
    {
        ILeaveEmployeeApplicationStatusReportBA _ILeaveEmployeeApplicationStatusReportBA = null;
        IOrganisationDepartmentMasterBA _IOrganisationDepartmentMasterBA = null;
        ...
        {
            _ILeaveEmployeeApplicationStatusReportBA = new LeaveEmployeeApplicationStatusReportBA();
            _IOrganisationDepartmentMasterBA = new OrganisationDepartmentMasterBA();
        ...
        public IEnumerable<LeaveEmployeeApplicationStatusReportViewModel> GetLeaveEmployeeApplicationStatusReportRecords(out int TotalRecords, string CentreCode, string DepartmentIds, string ApprovalStatus, string FromDate, string UptoDate, int EmployeeID)
        {
            ...
            IBaseEntityCollectionResponse<LeaveEmployeeApplicationStatusReport> baseEntityCollectionResponse = _ILeaveEmployeeApplicationStatusReportBA.GetBySearch(searchRequest);
