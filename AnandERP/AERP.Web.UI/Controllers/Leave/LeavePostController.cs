...
{
    public class LeavePostController : BaseController
    {
        ...
        public ActionResult Index()
        {
            try
            {
                ...
                {
                    return View("/Views/Leave/LeavePost/Index.cshtml");
                }
                else
                {
        ...
        public ActionResult List(string actionMode, string centerCode, string centreName)
        {
            try
            {
                ...
                return PartialView("/Views/Leave/LeavePost/List.cshtml", _LeavePostViewModel);
            }
            catch (Exception ex)
            {
                _logException.Error(ex.Message);
        ...
        public ActionResult Create(string CentreCode, string LeaveMasterID, string LeaveDescription)
        {
            ...
            return View("/Views/Leave/LeavePost/Create.cshtml", _LeavePostViewModel);
        }
        ...
        public ActionResult Edit(string ID, string LeaveDescription, string Mode)
        {
            ...
            if ("1" == Mode)
            {
                return View("/Views/Leave/LeavePost/Edit.cshtml", _LeavePostViewModel);
            }
            else
            {
                return View("/Views/Leave/LeavePost/ViewDeatils.cshtml", _LeavePostViewModel);
            }
        }
        ...
        public ActionResult ViewSessionDetails(string LeavePostID, string CentreCode, string CentreName, string Mode)
        {
            ...
            return View("/Views/Leave/LeavePost/ViewSessionDetails.cshtml", _LeavePostViewModel);
        }
        ...
        public ActionResult CreateLeavePostDetails(string LeavePostID, string centreCode, string centreName, string Mode)
        {
            ...
            return View("/Views/Leave/LeavePost/CreateLeavePostDetails.cshtml", _LeavePostViewModel);
        }
        ...
        public ActionResult AjaxHandler(JQueryDataTableParamModel param, string CentreCode)
        {
            ...
            var result = from c in records select new[] { Convert.ToString(c.EmployeeFirstName + " " + c.EmployeeMiddleName + " " + c.EmployeeLastName), Convert.ToString(c.EmployeeID), Convert.ToString(c.LeaveList), Convert.ToString(c.LeaveSessionID), Convert.ToString(c.DOJAndCurrentSessionDifferenceInMonth) };
